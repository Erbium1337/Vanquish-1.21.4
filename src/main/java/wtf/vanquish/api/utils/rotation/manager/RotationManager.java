package wtf.vanquish.api.utils.rotation.manager;
...
import wtf.vanquish.api.event.events.client.GameLoopEvent;
...
import wtf.vanquish.api.event.events.player.other.PostRotationMovementInputEvent;
import wtf.vanquish.api.event.events.player.move.VelocityEvent;
...
import wtf.vanquish.api.utils.task.TaskProcessor;
