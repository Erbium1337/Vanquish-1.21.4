package wtf.vanquish.api.utils.other;
...
import wtf.vanquish.api.utils.render.fonts.MsdfGlyph;
...
public class TextUtil implements QuickImports {
    ...
    public void sendMessage(String message) {
        mc.player.sendMessage(Text.literal("").append(gradient(ClientInfo.REAL, true)).append(Text.literal(Formatting.GRAY + " > " + Formatting.RESET + message)), false);
    }
