package wtf.vanquish.client.ui.theme;
...
public class ThemeEditor extends UIComponent {
    ...
    private final Theme defaultTheme = new Theme("Vanquish");
            ...
            switch (keyCode) {
                ...
                case GLFW.GLFW_KEY_ENTER -> {
                    if (!typingText.isEmpty()) {
                        ...
                        if (!exists) {
                            Theme newtfeme = new Theme(ThemeManager.getInstance().safeFileName(typingText));
                            newtfeme.getElementColors().clear();
                            for (Theme.ElementColor elementColor : currentTheme.getElementColors()) {
                                newtfeme.getElementColors().add(new Theme.ElementColor(
                                        elementColor.getName(),
                                        elementColor.getColor()
                                ));
                            }

                            themeSelectables.add(new ThemeSelectable(newtfeme));
                            currentTheme = newtfeme;
                        }
