...
import wtf.vanquish.api.utils.combat.CombatExecutor;
import wtf.vanquish.api.utils.combat.TargetManager;
import wtf.vanquish.api.utils.neuro.AIPredictor;
import wtf.vanquish.api.utils.rotation.misc.AuraUtil;
import wtf.vanquish.api.utils.math.MathUtil;
import wtf.vanquish.api.utils.rotation.RotationUtil;
import wtf.vanquish.api.utils.rotation.manager.Rotation;
import wtf.vanquish.api.utils.rotation.manager.RotationManager;
import wtf.vanquish.api.utils.rotation.manager.RotationMode;
import wtf.vanquish.api.utils.rotation.manager.RotationStrategy;
import wtf.vanquish.api.utils.rotation.rotations.*;
...
import wtf.vanquish.client.features.modules.movement.MoveFixModule;
